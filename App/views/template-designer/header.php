        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav>
                <ul class="nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= BASEURL ?>/InspirasiDesigner">Inspiration</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= BASEURL ?>/JobDesigner">Job</a></li>
